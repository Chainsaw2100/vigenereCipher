...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_2.setText(_translate("MainWindow", "Ключ (от 2 до 10 символов)"))
        self.label_3.setText(_translate("MainWindow", "Зашифрованные данные"))
        self.pushButton_2.setText(_translate("MainWindow", "Расшифровать (упрощенно)"))
class Ui_OtherWindow(object):
    def decrypt_better(self):
        pass
    def prevv(self):
        global i
        global i2
...
class MyWin(QtWidgets.QMainWindow):
    ...
    def MyFunction_2(self):
        ...
        for i in range(len(list_sorted)):
            lisd = []
            for e in range(len(cipher)):
                g = alph.index(cipher[e]) % 26 - alph.index(list_sorted[i][e]) % 26
