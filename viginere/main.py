...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_2.setText(_translate("MainWindow", "Ключ (от 2 до 8 символов)"))
...
class Ui_OtherWindow(object):
    ...
    def decrypt_better(self,list_divided):
        pass
    ...
    def setupUi(self, OtherWindow):
        ...
        self.pushButton_4.setGeometry(QtCore.QRect(290, 300, 261, 23))
        self.pushButton_4.setObjectName("pushButton_4")
        self.pushButton_4.clicked.connect(self.decrypt_better)
        self.label_2 = QtWidgets.QLabel(self.centralwidget)
    ...
    def retranslateUi(self, OtherWindow):
        ...
        self.pushButton_4.setText(_translate("OtherWindow", "Нет, расшифровать дополнительно"))
...
class MyWin(QtWidgets.QMainWindow):
    ...
    def MyFunction_3(self):
        ...
        self.ui.openWindow()
        cipher = self.ui.textEdit_2.toPlainText()
        key_len=find_key_length(cipher,4,8)
...
def get_list_decrypted(a,b,h):
    ...
    if len(a)==2 or len(a)==3 or len(a)==4:
        list_letters.append('s')
    if len(a)>7:
        list_letters.remove('n')
        list_letters.remove('i')
        list_letters.remove('o')
